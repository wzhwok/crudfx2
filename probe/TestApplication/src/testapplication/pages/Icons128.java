...
public class Icons128 {
	...
	if(page==null){
		...
		.title("128 x 128")
		    ...
		    .item(new StandardLabel().title("i128_dictionary  ").icon(CRUDfxIcons.i128_dictionary))
		    ...
		    .item(new StandardLabel().title("i128_important  ").icon(CRUDfxIcons.i128_important))
		    .item(new StandardLabel().title("i128_information  ").icon(CRUDfxIcons.i128_information))
